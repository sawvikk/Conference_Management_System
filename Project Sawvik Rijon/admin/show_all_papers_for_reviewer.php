...
<div class="container-fluid mt-5">
    <h3 class="text-center text-dark fw-bold">Select Paper for Multiple Reviewers</h3>
    <div class="col">
        <div class="card pt-5 pb-4 shadow mb-5 px-md-5 px-3 bg-body rounded">
            <div class="table-responsive">
                <table id="table" class="table table-bordered table-hover text-center">
                    <thead>
                        <tr>
                            <th class="text-dark">Serial No</th>
                            <th>Paper Title</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    ?>
                                    <td>
                                        <a href="assign_reviewer_table.php?paper_id=<?php echo $paper_id ?>" class="btn btn-primary" onclick="return confirmAssign()">Select Reviewers</a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
