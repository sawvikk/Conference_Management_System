...
// echo "insert query ";
<script>
                        alert("Please check your email to get verification code. ");
...
echo $status;
    ...
    // echo "<p class='text-danger text-bold text-center fs-5 mt-3'>Form is not submitted yet.</p>";
}
?> 
