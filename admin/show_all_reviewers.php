...
<div class="container-fluid mt-5">
    <h3 class="text-center text-dark fw-bold">All Reviewer Details</h3>
    <div class="col">
    ...
    <?php 
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <a href="assigned_papers_to_reviewer.php?reviewer_id=<?php echo $reviewer_id  ?>" class="btn btn-primary">Assigned Papers</a>
                    </td>
                </tr>
