...
<div class="container-fluid mt-5">
    <h3 class="text-center text-dark fw-bold">All Assigned Papers</h3>
    <div class="col">
            ...
            <div class="table-responsive">
                <table id="table" class="table table-bordered table-hover text-center">
                    ...
                    <tbody>
                        ...
                        $select_from_new_paper = "SELECT np.paper_id,np.paper_title,np.paper_keywords,np.track,np.authors_name, np.authors_affiliation, np.authors_email,np.manuscript_pdf, np.timestamps FROM new_paper np JOIN review_table rt ON np.paper_id = rt.paper_id WHERE rt.review_status = 'Assigned' AND rt.reviewer_id='$reviewer_id' ";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="review_form.php?paper_id=<?php echo $paper_id ?>" class="btn btn-primary">Review</a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
