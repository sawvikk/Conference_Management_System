...
<div class="container-fluid mt-5">
    <h3 class="text-center text-dark fw-bold">All Pending Reviewer Details</h3>
    <div class="col">
...
<tbody>
    <?php 
        $select = "SELECT * FROM `reviewers` WHERE admin_approved='0'";
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <a href="approve_reviewer.php?reviewer_id=<?php echo $reviewer_id ?>" class="btn btn-primary">Approve</a>
                    </td>
                    <td>
                        <a href="delete_pending_reviewer.php?id=<?php echo $reviewer_id ?>&&image=<?php echo $image; ?>" class="btn btn-primary" onclick="return confirmSubmission()">Delete</a>
                    </td>
                </tr>
